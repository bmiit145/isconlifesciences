<style>
    ...
    /* CSS to make reCAPTCHA responsive */
    .g-recaptcha {
...
<div class="contactform wow fadeInRight" data-wow-delay=".4s">
    <div class="contactform__list mb-30">
        ...
        <form id="bro_form" action="#" method="POST">
            ...
            <div class="row">
                <div class="contactform__title mb-30 fs-4 fw-bold p-0">Send us a Message :</div>
                ...
                <div class="col-lg-12 g-recaptcha mb-30 p-0" data-sitekey="6LcSPbIpAAAAALm5GrGa9HprQyIa8NAK7Q_hw6p-"
                    data-action="LOGIN">
                </div>
                <div class="col-lg-12 p-0">
