...
$(document).on('click', '.readmore_readless', function() {
	var product = $(this).closest(".services-thumb-box__text-area");
	var description = product.find(".description");
	var btnText = product.find(".readmore_readless");
	var dot_remove = product.find(".dot_remove");
	var description_inline = product.find(".description_inline");

	if (description.is(":hidden")) {
		btnText.text("Read less");
		description_inline.addClass("description_inline_block");
		description.slideDown();
		dot_remove.hide();
	} else {
		btnText.text("Read more");
		description_inline.removeClass("description_inline_block");
		description.slideUp();
		dot_remove.show();
	}
});